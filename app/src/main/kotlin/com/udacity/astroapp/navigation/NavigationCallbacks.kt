...
/**
 * Interface defining navigation callbacks for inter-screen navigation.
 * These callbacks handle navigation between different screens in the app.
 * UI-specific actions like share and fullscreen remain at the screen level.
 */
